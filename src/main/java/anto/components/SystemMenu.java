package anto.components;

import com.formdev.flatlaf.FlatClientProperties;

import anto.forms.BlurDashboard;
...
public class SystemMenu extends BlurChild {
    ...
    private SimpleHeaderData getHeaderData() {
        return new SimpleHeaderData()
                .setTitle("Sanmi Jevir Trinidad Andrade")
                .setDescription("Odontologa")
                .setIcon(new AvatarIcon(getClass().getResource("/anto/images/LogoClinica.png"), 60, 60, 999));
    }
    ...
    private SimpleMenuOption getMenuOption() {
        raven.drawer.component.menu.data.MenuItem items[] = new raven.drawer.component.menu.data.MenuItem[]{
                ...
                new Item.Label("Consultorio"),
                new Item("Citas", "email.svg")
                        .subMenu("Agendar Cita")
                        .subMenu("Ver Citas")
                        .subMenu("Eliminar Cita"),
                new Item("Inventario", "chat.svg"),
                new Item("Calendario", "calendar.svg"),
                new Item.Label("Pacientes"),
